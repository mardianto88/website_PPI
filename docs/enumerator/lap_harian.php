...
<html lang="en">
  <head>
    ...
    <title>Laporan Harian Lelang Ikan</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-print"></i><span class="app-menu__label">Laporan</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <li><a class="treeview-item " href="lap_ikan.php"><i class="icon fa fa-circle-o"></i> Jenis Ikan</a></li>
           ...
           <li><a class="treeview-item " href="lap_rtp.php"><i class="icon fa fa-circle-o"></i> Nama RTP PP</a></li>
              ...
              <li><a class="treeview-item active" href="lap_harian.php"><i class="icon fa fa-circle-o"></i> Hasil Tangkapan Per Harian</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-print"></i> Form Cetak Laporan Data Harian</h1>
          <p>Laporan Data Harian Lalang Ikan</p>
        </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <form action="lap_harian_detail.php" method="GET" class="form-horizontal">

                <div class="form-group row">
                  <label class="control-label col-md-3">Tanggal Lelang</label>
                  <div class="col-md-8">
                    <input class="form-control" type="date" id='tgl' name="tgl" placeholder="tanggal lelang" autofucus="jenis_ikan" required="true">
                  </div>
                </div>
