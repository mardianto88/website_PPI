  ...
  <body class="app sidebar-mini rtl">
   ...
   include "koneksi.php";
              ...
              if (isset($_POST['ubah_data'])) {
               ...
               $update = mysqli_query($koneksi, "UPDATE hasil SET id_transaksi='$id_transaksi', tgl='$tgl', id_km='$id_km', id_ikan='$id_ikan', kg='$kg', harga='$harga', jumlah_harga='$jumlah_harga' WHERE id_transaksi='$id_transaksi'") or die(mysql_error());
               if ($update) {
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Form Ubah Data Hasil Tangkapan</h1>
          <p>Ubah Data Hasil Tangkapan</p>
        </div>
      </div>
      <?php 
                    include "koneksi.php";
                    $id_transaksi = $_GET['id_transaksi'];
                    $query_mysql = mysqli_query($koneksi, "SELECT * FROM hasil WHERE id_transaksi='$id_transaksi'")or die(mysql_error());
            ...
            <div class="tile-body">
              ...
              <form name="autoSumForm" action="" method="post" class="form-horizontal">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-3" name="id_transaksi" type="text" placeholder="ID. Transaksi" required="true" value="<?php echo $tampil['id_transaksi'] ?>" readonly="true" >
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Tanggal Lelang</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-4" type="date" name="tgl" placeholder="Jenis Ikan" value="<?php echo $tampil['tgl'] ?>" readonly="true" >
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control"  type="text" name="kg" placeholder="Hasil Tangkapan Dalam KG" required="kg" onfocus="startCalc();" value="<?php echo $tampil['kg'] ?>">
                  </div>
                </div>
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="harga" placeholder="Harga Per Kilogram" required="true" onfocus="startCalc();" onblur="stopCalc();" value="<?php echo $tampil['harga'] ?>" >
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Total Harga" name="jumlah_harga" readonly="true" value="<?php echo $tampil['jumlah_harga'] ?>">
                  </div>
                </div>
            <div class="tile-footer">
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button name="ubah_data" onclick="return confirm('Yakin Ubah Data')" class="btn btn-outline-danger">Ubah</button>
