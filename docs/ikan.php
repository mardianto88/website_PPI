...
<html lang="en">
  <head>
    ...
    <title>Form Input Data Jenis Ikan</title>
    <meta charset="utf-8">
  ...
  <?php 
    include "koneksi.php";
                  if (isset($_POST['simpandatax'])) {
                      ...
                      $x ="INSERT INTO ikan(id_ikan, jenis_ikan) VALUES ('$id_ikan', '$jenis_ikan')";
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Input Data PPI</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="ikan.php"><i class="icon fa fa-circle-o"></i> Input Jenis Ikan</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Form Input Data Jenis Ikan</h1>
          <p>Input Data Jenis Ikan</p>
        </div>

         <?php 
            include "koneksi.php";
               $carikode = mysqli_query($koneksi, "select max(id_ikan) from ikan") or die (mysql_error());
               $datakode =mysqli_fetch_array($carikode);
               if ($datakode) {
                  $nilaikode =substr($datakode[0], 0);
                  $kode = (int) $nilaikode;
                  $kode =$kode + 1 ;
                  $id_ikan = "".str_pad($kode, 5, "0", STR_PAD_LEFT);
               } else {
                  $id_ikan = "00001";
               }
            ?>
            ...
            <div class="tile-body">
              <form action="" method="post" class="form-horizontal">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" name="id_ikan" placeholder="ID" value="<?php echo $id_ikan?>" readonly="true">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Jenis Ikan</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="jenis_ikan" placeholder="Jenis Ikan" autofucus="jenis_ikan" required="true">
                  </div>
                </div>
