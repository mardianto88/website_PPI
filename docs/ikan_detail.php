...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Detail Data PPI</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
           <li><a class="treeview-item " href="km_detail.php"><i class="icon fa fa-circle-o"></i> Detail Kapal Motor</a></li>
            ...
            <li><a class="treeview-item active" href="ikan_detail.php"><i class="icon fa fa-circle-o"></i> Detail Jenis Ikan</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Data Jenis Ikan</h1>
          <p>Detail Jenis Ikan </p>
        </div>
      </div>
          ...
          <div class="tile">
            <div class="tile-body">
             ...
             <form action="" method="post">
               <a href="ikan.php" class="btn btn-info btn-sm">Tambah</a>
               <a href="lap_ikan.php" class="btn btn-success btn-sm">Print</a>
            </form>
            ...
            <thead>
                <tr>
                    <th width="5%"><div align="center">ID Ikan </div></th>
                    <th width="35%"><div align="center">Jenis Ikan</div></th>
            ...
            <tbody>
                <?php
                          include "koneksi.php";
                             $sql = mysqli_query($koneksi, "SELECT * FROM ikan");
                              while ($tampil = mysqli_fetch_array($sql)) {
                               ?>

                                <tr>
                                 
                                 <td align="center"><span class="style1"><?php echo $tampil['id_ikan'] ?></span></td>
                                  <td ><span class="style1"><?php echo $tampil['jenis_ikan'] ?></span></td>
                                   </td>
                                   <td><a href="ikan_edit.php?id_ikan=<?php echo $tampil['id_ikan']; ?>" class="btn btn-outline-primary btn-sm">Ubah</a>
                                   
                                   <a href="ikan_hapus.php?id_ikan=<?php echo $tampil['id_ikan']; ?>" name="hapus_data"  class="btn btn-outline-danger btn-sm" onclick="return confirm('Yakin Hapus Data')" >Hapus</a>
                                   </td>
                                  <?php  }  ?> 
                            </table>
            </div>
