...
<html lang="en">
  <head>
    ...
    <title>Form Ubah Jenis Ikan</title>
    <meta charset="utf-8">
...
if (isset($_POST['ubah_data'])) {
 ...
 $update = mysqli_query($koneksi, "UPDATE ikan SET id_ikan='$id_ikan', jenis_ikan='$jenis_ikan' WHERE id_ikan='$id_ikan'") or die(mysql_error());
 if ($update) {
...
?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Form Ubah Data Kapal Motor</h1>
          <p>Ubah Data Kapal Motor</p>
        </div>
      </div>
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
                ...
                <?php 
                    ...
                    $query_mysql = mysqli_query($koneksi, "SELECT * FROM ikan WHERE id_ikan='$id_ikan'")or die(mysql_error());
              ...
              <form action="" method="post" class="form-horizontal">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" name="id_ikan" placeholder="ID Ikan" value="<?php echo $tampil['id_ikan'] ?>" readonly="true">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Jenis Ikan</label>
                  <div class="col-md-8">
                    <input class="form-control" name="jenis_ikan" type="text" placeholder="Jenis Ikan" value="<?php echo $tampil['jenis_ikan'] ?>">
                  </div>
                </div>
            <?php } ?>
