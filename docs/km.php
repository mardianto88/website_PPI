...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
     ...
     <?php
                  ...
                  if (isset($_POST['simpandatax'])) {
                      $id_km  = $_POST['id_km'];
                      $nama_km = $_POST['nama_km'];
                     
                   
                      
                      $x ="INSERT INTO km(id_km, nama_km) VALUES ('$id_km', '$nama_km')";
      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Input Data PPI </span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="km.php"><i class="icon fa fa-circle-o"></i> Input Kapal Motor</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Form Input Data Kapal Motor</h1>
          <p>Input Data Kapal Motor</p>
        </div>
         <?php 
            include "koneksi.php";
               $carikode = mysqli_query($koneksi, "select max(id_km) from km") or die (mysql_error());
               $datakode =mysqli_fetch_array($carikode);
               if ($datakode) {
                  $nilaikode =substr($datakode[0], 3);
                  $kode = (int) $nilaikode;
                  $kode =$kode + 1 ;
                  $id_km = "KM.".str_pad($kode, 5, "0", STR_PAD_LEFT);
               } else {
                  $id_km = "KM.00001";
               }
            ?>
            ...
            <div class="tile-body">
              <form  action="" method="post" class="form-horizontal" >
                <div class="form-group row">
                  <label class="control-label col-md-3">ID. Kapal Motor</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" name="id_km" placeholder="ID Kapal Motor" value="<?php echo $id_km ?>" readonly="true" >
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Nama Kapal Motor</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="nama_km" placeholder="Nama Kapal Motor" required="true">
                  </div>
                </div>
