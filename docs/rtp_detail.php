        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Detail Data PPI</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
           <li><a class="treeview-item " href="km_detail.php"><i class="icon fa fa-circle-o"></i> Detail Kapal Motor</a></li>
            <li><a class="treeview-item active" href="rtp_detail.php"><i class="icon fa fa-circle-o"></i> Detail Nama RTP/PP</a></li>
          ...
          <div class="tile">
            <div class="tile-body">
             <form action="" method="post">
               <a href="rtp.php" class="btn btn-info btn-sm">Tambah</a>
                <a href="lap_rtp.php" class="btn btn-success btn-sm">Print</a>
            </form>
                                ...
                                <tr>
                                 ...
                                 <td align="center"><span class="style1"><?php echo $tampil['id_rtp_pp'] ?></span></td>
                                  <td ><span class="style1"><?php echo $tampil['nama_rtp_pp'] ?></span></td>
                                   ...
                                   <td><a href="rtp_edit.php?id_rtp_pp=<?php echo $tampil['id_rtp_pp']; ?>" class="btn btn-outline-primary btn-sm">Ubah</a>
                                   
                                   <a href="rtp_hapus.php?id_rtp_pp=<?php echo $tampil['id_rtp_pp']; ?>" name="hapus_data"  class="btn btn-outline-danger btn-sm" onclick="return confirm('Yakin Hapus Data')" >Hapus</a>
                                   </td>
                                  <?php  }  ?> 
                            </table>
            </div>
