      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-print"></i><span class="app-menu__label">Laporan</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="lap_tahunan.php"><i class="icon fa fa-circle-o"></i> Laporan Tahunan</a>
          </ul>
        </li>
      </ul>
    </aside>
            ...
            <div class="tile-body">
              <form class="form-horizontal">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" placeholder="ID. RTP/PP">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Nama RTP/PP</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Nama RTP/PP">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="MT (MG)">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Jenis Alat Utama</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Jenis Alat Utama">
                  </div>
                </div>
            ...
            <div class="tile-footer">
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button name="" onclick="return confirm('Yakin Simpan Data')" class="btn btn-outline-danger">SIMPAN</button>
